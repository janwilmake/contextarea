...
- **BONUS** The challenge is making md proper HTML as it streams in, and making untrusted HTML trusted. What if I solve this by creating a simplified wrapper that directly streams out chunks of html with blocks. This would make any STREAMING client incredibly simple to be built! **Making people make money with me should be the goal**
...
<!--
Stay logged out from X until this is done

Preferably lock into this very thing in VSCode
-->
